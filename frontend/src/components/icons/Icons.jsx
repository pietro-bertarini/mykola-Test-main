 ...
 */
export const MetaMaskLogo = ({ className = '' }) => (
  <svg 
    width="24" 
    height="24" 
    viewBox="0 0 33 31" 
    ...
    className={`metamask-logo ${className}`}
  >
 ...
 * @returns {JSX.Element} Clipboard icon
 */
export const ClipboardIcon = () => (
  <span role="img" aria-label="clipboard" style={{ fontSize: '18px' }}>
    📋
  </span>
);
